...
//  Final_NHS_App
//
//  Created by Travis Zhang on 5/1/19.
...
class BaseViewController: UIViewController, SlideMenuDelegate {
    ...
    func slideMenuItemSelectedAtIndex(_ index: Int32) {
        ...
        case 1:
            ...
            self.openViewControllerBasedOnIdentifier("ExcusedAbsence")
            
            break
        case 2:
            print("Volunteer Opportunities\n", terminator:"")
            
            self.openViewControllerBasedOnIdentifier("VolunteerOpp")
            
            break
        case 3:
            print("Committee Meetings\n", terminator:"")
            
            self.openViewControllerBasedOnIdentifier("CommitteeVC")
